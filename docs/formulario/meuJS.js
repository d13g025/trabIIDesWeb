...
function verificarIdade() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        formulario.addEventListener('submit', function(event) {
            ...
            let estilo = document.querySelector('input[name="estilo"]:checked');

            if (estilo) {
                estilo = estilo.value; // Obter o valor do elemento selecionado
            } 

            let resultado = `Olá ${nome}, obrigado por responder ao questionário. Vi que gosta de ${estilo}. e tem ${idade} anos, a vida é uma criança!`;
